...
const projectsData: ProjectData[] = [
  ...
  {
    title: "Engram - Personality-Parameterized NPC Memory",
    description: "OCEAN-trait Prolog-based memory schemas producing trait-consistent cognitive diversity in NPCs",
    bulletPoints: [
      "Parameterized OCEAN (Big Five) personality traits with Prolog-based memory encoding rules",
      "Enabled NPCs to form structurally different memories from identical experiences",
      "Produced trait-consistent cognitive diversity without hand-scripting",
      "Under review at FDG '26",
    ],
    tags: ["NeuroSymbolic AI", "LLMs", "Game AI", "Prolog"],
    techStack: ["Python", "SWI-Prolog", "LLMs", "Unity"],
    contributors: ["Ashmita Dua", "Devesh Kriplani"],
    association: "AI Explainability & Accountability Lab",
  ...
  {
    title: "HabPet - IoT Habit Tracker",
    description: "ESP32 + web app habit tracker with AI habit detection via OpenCV and milestone rewards",
    bulletPoints: [
      "Built IoT habit tracker combining ESP32 hardware with a web app and AI-powered habit detection via OpenCV",
      "Engineered Node.js bridge for real-time ESP32-web communication using sensors and actuators (servos, LEDs, buzzers)",
      "Implemented progressive milestone rewards system",
      "Deployed full-stack application using React/Vite/Zustand on Vercel",
    ],
    tags: ["IoT", "Computer Vision", "Full-Stack"],
    techStack: ["ESP32", "React", "Vite", "Zustand", "Node.js", "OpenCV"],
    contributors: ["Ashmita Dua", "Sanya"],
    date: "2025",
    images: ["https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&h=500&fit=crop"],
    link: "https://habit-bot.vercel.app",
    github: "https://github.com/Sanyab8/habit-bot",
  },
  {
    title: "CopCuts - Barber LLM-based NPCs Unity Game",
    description: "AI detective game with LLM-powered NPCs featuring dynamic conversations and suspicion mechanics",
    bulletPoints: [
      "Built AI detective game with LLM-powered NPCs featuring dynamic conversations, memory systems, and personality adaptation",
      ...
      "Designed barber-shop setting with branching dialogue grounded in NPC memory",
    ],
    tags: ["Unity", "LLMs", "Game AI"],
    techStack: ["Unity", "C#", "LLMs"],
    contributors: ["Ashmita Dua"],
    date: "2025",
    images: ["https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&h=500&fit=crop"],
    link: "#",
    github: "#",
  },
  {
