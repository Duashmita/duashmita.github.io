  ...
  return (
    <section className="py-16 px-4">
      <div className="container mx-auto max-w-3xl">
        <p className="text-lg md:text-xl leading-relaxed text-foreground/90 font-serif italic scroll-reveal">
        ...
        <p className="mt-6 text-base md:text-lg leading-relaxed text-muted-foreground scroll-reveal reveal-delay-1">
